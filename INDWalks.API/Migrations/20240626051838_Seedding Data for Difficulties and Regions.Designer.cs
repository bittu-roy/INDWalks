...
namespace INDWalks.API.Migrations
{
    ...
    [Migration("20240626051838_Seedding Data for Difficulties and Regions")]
    partial class SeeddingDataforDifficultiesandRegions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("INDWalks.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72d286ce-ab51-405a-8042-eefa52346af6"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("7e653e77-f773-4cc6-8c4c-00135a8d1f8a"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("9358963d-1f5e-464a-9c9d-02954843c999"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("INDWalks.API.Models.Domain.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4a5edd9a-1f83-4445-8e5b-8735bb5ae901"),
                            Code = "DGP",
                            Name = "Durgapur",
